...
public class AsrDemo implements NlsListener {
    ...
    public void onMessageReceived(NlsEvent e) {
        //识别结果的回调
        NlsResponse response = e.getResponse();    //获取response对象
        String result = "";
        int statusCode = response.getStatus_code();    //获取状态码
        //getAsr_ret()：服务器返回的json格式数据
    ...
    public static void main(String[] args) {
        String akId = "LTAIJWo4iJzsI0p2";
        String akSecret = "efhvbPMbWGAVPrnGpAy3hcxErUDl5Y";
